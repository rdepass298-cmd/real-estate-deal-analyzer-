    ...
    <main className="min-h-screen bg-slate-950 px-6 py-10 text-slate-100 sm:px-10">
      <div className="mx-auto max-w-6xl">
        <section className="mx-auto max-w-3xl py-16 text-center sm:py-20">
          <p className="inline-flex rounded-full border border-cyan-500/30 bg-cyan-500/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-cyan-200">
        ...
        <section className="py-10 sm:py-14">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              >
                <div className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-cyan-500/30 bg-cyan-500/10 text-sm font-semibold text-cyan-200">
                  {card.icon}
                </div>
        ...
        <section id="pricing" className="py-10 sm:py-14">
          ...
          <div className="mx-auto mt-8 grid max-w-4xl gap-5 sm:grid-cols-2">
            ...
            <article className="relative rounded-3xl border border-cyan-400/50 bg-slate-900/80 p-7 shadow-xl shadow-cyan-900/10">
              <span className="absolute -top-3 right-5 rounded-full border border-cyan-500/30 bg-cyan-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-cyan-200">
                Most popular
              </span>
              <p className="text-sm uppercase tracking-[0.25em] text-cyan-200">Pro</p>
