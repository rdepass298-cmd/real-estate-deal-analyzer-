...
export default function UpgradePage() {
 ...
 <p className="text-sm uppercase tracking-[0.35em] text-gold-light">Pricing</p>
 ...
 <h2 className="text-xl font-semibold text-gold-light">Pro Includes</h2>
 ...
 className="rounded-2xl bg-gold px-6 py-3 font-semibold text-gold-dark transition hover:bg-gold/90 disabled:cursor-not-allowed disabled:opacity-50"
 >
