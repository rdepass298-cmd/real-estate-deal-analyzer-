...
export default function AuthHeader() {
 ...
 {plan === 'free' ? (
 <Link href="/upgrade" className="text-sm font-medium text-gold-light transition hover:text-gold-light">
 Upgrade
 </Link>
 ) : null}
 ...
 <>
 <Link href="/auth/login" className="text-sm font-medium text-gold-light transition hover:text-gold-light">
 Log in
 </Link>
 <Link
 href="/auth/signup"
 className="rounded-2xl border border-gold/30 bg-gold/10 px-4 py-2 text-sm font-medium text-gold-light transition hover:bg-gold/20"
 >
 Sign up free
 </Link>
 </>
